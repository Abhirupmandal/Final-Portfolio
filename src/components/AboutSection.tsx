...
import dineshSirImg from "@/assets/dinesh-sir.png";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const AboutSection = () => {
  const { ref, isVisible } = useScrollAnimation();
  return (
    <section id="about" className="px-[5%] md:px-[8%] py-20 md:py-28 bg-[var(--section-alt)] relative">
      <div ref={ref} className={`${isVisible ? "scroll-visible" : "opacity-100 md:opacity-0 transition-opacity"}`}>
        {/* Coaching Philosophy */}
